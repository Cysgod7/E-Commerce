...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{asset('front-asset')}}/css/owl.carousel.css">
...
<script src="{{asset('front-asset')}}/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="{{asset('front-asset')}}/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="{{asset('front-asset')}}/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="{{asset('front-asset')}}/js/bxslider.min.js"></script>
<script type="text/javascript" src="{{asset('front-asset')}}/js/script.slider.js"></script>
